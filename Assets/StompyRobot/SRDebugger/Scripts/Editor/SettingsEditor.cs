		...
		public override void OnInspectorGUI()
		{
			...
			if (_enableKeyboardShortcutsProperty.boolValue) {
				...
				if (_keyboardFoldoutVisible) {
					...
					_keyboardModifierControlProperty.boolValue = EditorGUILayout.Toggle(_keyboardModifierControlProperty.boolValue, GUILayout.Width(20));
					GUILayout.Label("Ctrl");

					_keyboardModifierShiftProperty.boolValue = EditorGUILayout.Toggle(_keyboardModifierShiftProperty.boolValue, GUILayout.Width(20));
					GUILayout.Label("Shift");

					_keyboardModifierAltProperty.boolValue = EditorGUILayout.Toggle(_keyboardModifierAltProperty.boolValue, GUILayout.Width(20));
					GUILayout.Label("Alt");
